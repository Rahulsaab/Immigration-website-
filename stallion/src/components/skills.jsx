    ...
    <>
      <section>
        <div className="container13">
          <div className="heading9 animate__animated animate__zoomIn">
            SKILLED
            <br />
            IMMIGRATION
          </div>
        ...
        <div className="container14">
          <div className="heading10">Express Entry Excellence</div>
          ...
          <div>
            <div className="d6">
              <i className="fa-solid fa-certificate" /> Federal Skilled Worker:
            ...
            <div className="d6">
              <i className="fa-solid fa-certificate" /> Federal Skilled Trade:
            ...
            <div className="d6">
              <i className="fa-solid fa-certificate" /> Canadian Experience
          ...
          <div className="heading13">
            <div className="heading14">Sponsorship Immigration</div>
            <div className="div2">
              <Card
